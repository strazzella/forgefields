...
if (!function_exists('wp_check_invalid_utf8')) {
    function wp_check_invalid_utf8(mixed $string, bool $strip = false): string
    {
...
if (!function_exists('wp_nonce_field')) {
    function wp_nonce_field(...$args): string
    {
        return '';
    }
}
...
if (!function_exists('get_post_meta')) {
    function get_post_meta(...$args): mixed
    {
        return null;
    }
}
...
if (!function_exists('wp_get_attachment_image_src')) {
    function wp_get_attachment_image_src(...$args): mixed
    {
        return null;
    }
}
if (!function_exists('wp_get_attachment_url')) {
    function wp_get_attachment_url(...$args): string
    {
        return '';
    }
}
...
if (!function_exists('wp_basename')) {
    function wp_basename(mixed $path, string $suffix = ''): string
    {
...
if (!function_exists('check_admin_referer')) {
    function check_admin_referer(...$args): bool
    {
        return true;
    }
}
